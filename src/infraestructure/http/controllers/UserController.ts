...
import type { CreateUserUseCase } from '../../../application/use-cases/user/CreateUserUseCase.js'
...
export class UserController {
  ...
  createUser = async (req: Request<{}, {}, UserInput>, res: Response, next: NextFunction) => {
    try {
